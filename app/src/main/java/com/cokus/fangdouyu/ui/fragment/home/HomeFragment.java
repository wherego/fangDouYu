...
import com.cokus.fangdouyu.ui.activity.player.LivePlayerContract;
...
public class HomeFragment extends BaseFragment {
    ...
    protected void initActionBar(int actionbarID) {
        ...
        actionBar.isShowBottemLine(false)
                ...
                .setBarRight1("", R.drawable.image_search_normal, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {

                    }
                })
                .setBarRight2("", R.drawable.image_scanner_normal, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
