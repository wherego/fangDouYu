package com.cokus.fangdouyu.douyuDanmu.client;

import android.util.Log;


import com.cokus.fangdouyu.douyuDanmu.msg.DyMessage;
import com.cokus.fangdouyu.douyuDanmu.msg.MsgView;
import com.cokus.fangdouyu.douyuDanmu.utils.KeepAlive;
import com.cokus.fangdouyu.douyuDanmu.utils.KeepGetMsg;
...
public class DyBulletScreenClient {
    ...
    public interface HandleMsgListener {
        ...
        void handleRecycler(String txt);
    }
        ...
        if(msg.get("type") != null){
            ...
            if(msg.get("type").equals("chatmsg")){//弹幕消息
                if (!isHandleMsgListenerNull()) {
                    ...
                    mHandleMsgListener.handleRecycler("<font color=\"#00bbaa\">"+msg.get("nn").toString()+"</font>:"+msg.get("txt"));
                }
            }
            //@TODO 其他业务信息根据需要进行添加
