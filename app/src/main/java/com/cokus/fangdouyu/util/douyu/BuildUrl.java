package com.cokus.fangdouyu.util.douyu;
...
public class BuildUrl {
    ...
    public static String getDouyuRoomUrl(String roomId) {
        return "/lapi/live/thirdPart/getPlay/" + roomId + "?rate=0".toString();
    }

    public static HashMap<String, String> getDouyuRoomParams(String roomId) {
